...
> план их устранения. Удалить/заархивировать после выполнения.
...
5. `python -m pytest tests/ -q` — всё зелёное (сейчас 81 passed).
...
- Тесты не должны проседать ниже текущих 81.
